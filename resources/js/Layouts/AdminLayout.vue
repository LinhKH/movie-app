        ...
        <aside
            ...
            <div>
                ...
                <div class="mt-8 text-center">
                    ...
                    <h5 class="hidden mt-4 text-xl font-semibold text-gray-600 lg:block">{{ $page.props.auth.user.name }}
                    </h5>
                    <span class="hidden text-gray-400 lg:block">{{ $page.props.auth.user.email }}</span>
                </div>
