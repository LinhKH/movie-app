        ...
        <div class="max-w-7xl mx-auto py-4">
            <div class="flex justify-between">
                ...
                <Link :href="route('users.create')"
                    class="px-3 py-2 text-white font-semibold bg-indigo-500 hover:bg-indigo-700 rounded">New User</Link>
            </div>
            <div class="mt-6">
                <Table>
                    <template #header>
                    ...
                    <template #default>
                        <TableRow v-for="user in users" :key="user.id" class="border-b">
                            ...
                            <TableDataCell class="space-x-4">
                                <Link :href="route('users.edit', user.id)" class="text-green-400 hover:text-green-600">Edit
                                </Link>
